...
#saveRDS(sem_boruta, file = "./data/BorutaFeatures.rds")
sem_boruta <- readRDS(file = "./data/BorutaFeatures.rds")
```
...
#write.csv(foam_rf, "./data/SRN_Predictions861Accessions_82322_Final.csv")
